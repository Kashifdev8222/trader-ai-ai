        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-5xl mx-auto">
          ...
          <div className="relative rounded-xl bg-[var(--bg-card)] border border-[var(--border)] p-6 shadow-[var(--shadow-md)] overflow-hidden">
            ...
            {status === 'success' ? (
              <div className="text-center py-10 relative z-10">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#10b981]/15 to-[#10b981]/5 flex items-center justify-center mx-auto mb-5 shadow-lg shadow-[#10b981]/10">
              ...
              <form onSubmit={submit} autoComplete="off" className="space-y-4 relative z-10">
                {[{ n: 'firstName', l: 'First Name' }, { n: 'lastName', l: 'Last Name' }, { n: 'email', l: 'Email' }].map((f) => (
                  <div key={f.n}>
                    ...
                    <input name={f.n} value={form[f.n]} onChange={hc} required placeholder={`Enter your ${f.l.toLowerCase()}`} className="w-full px-4 py-3 rounded-xl bg-[var(--bg)] border border-[var(--border-strong)] text-[var(--text)] text-sm placeholder-[var(--text-secondary)] focus:outline-none focus:border-[#10b981]/50 focus:ring-2 focus:ring-[#10b981]/10 transition-all"/>
                  </div>
                ))}
                <div>
                ...
                <button type="submit" disabled={status === 'loading'} className="w-full py-4 rounded-xl bg-[#10b981] hover:bg-[#059669] text-white font-bold text-sm transition-all shadow-lg shadow-[#10b981]/20 hover:shadow-xl hover:shadow-[#10b981]/40 flex items-center justify-center gap-2">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-5">
                {[{ l: 'AU Phone', v: '+61 284 889 800' }, { l: 'UK Phone', v: '+44 203 927 2999' }, { l: 'Email', v: 'info@traderai.ai' }].map((item, i) => (
                  <div key={i} className="flex items-start gap-4 group">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#10b981]/15 to-[#10b981]/5 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                      {i < 2 ? (
            ...
            <div className="rounded-2xl bg-gradient-to-br from-[#10b981]/5 to-[#10b981]/[0.02] border border-[#10b981]/10 p-7 sm:p-8 text-center relative overflow-hidden">
              ...
              <button onClick={() => { const w = document.querySelector('[data-replain]'); if (w) w.click(); }} className="relative z-10 inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white font-semibold text-sm transition-all">
