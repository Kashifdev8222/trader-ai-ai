            ...
            <div className="rounded-2xl bg-gradient-to-br from-[#10b981]/5 to-[#10b981]/[0.02] border border-[#10b981]/10 p-7 sm:p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <button type="button" onClick={() => {
                  const tryOpen = () => { if (typeof window.ReplainAPI === 'function') { window.ReplainAPI('open'); return true; } return false; };
                  if (tryOpen()) return;
                  let tries = 0;
                  const id = setInterval(() => { tries++; if (tryOpen() || tries > 30) clearInterval(id); }, 100);
