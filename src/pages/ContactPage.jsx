      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-5xl mx-auto">
          ...
          <div className="rounded-2xl bg-[var(--bg-card)] border border-[var(--border)] p-7 sm:p-8 shadow-xl">
            ...
            {status === 'success' ? (
              <div className="text-center py-10">
                <div className="w-16 h-16 rounded-2xl bg-[#FC6612]/10 flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-[#FC6612]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/></svg>
                </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-5">
                {[{ l: 'AU Phone', v: '+61 284 889 800' }, { l: 'UK Phone', v: '+44 203 927 2999' }, { l: 'Email', v: 'info@traderai.ai' }].map((item, i) => (
                  <div key={i} className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[#FC6612]/10 flex items-center justify-center flex-shrink-0">
                      {i < 2 ? (
                        <svg className="w-5 h-5 text-[#FC6612]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                      ) : (
            ...
            <div className="rounded-2xl bg-gradient-to-br from-[#FC6612]/10 to-[#FC6612]/10 border border-[var(--border)] p-7 sm:p-8 text-center">
              ...
              <button className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#FC6612] hover:bg-[#0e5434] text-white font-semibold text-sm transition-all shadow-lg shadow-[#FC6612]/20">
