  ...
  return (
    <div className="pt-28 pb-20">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Inflation / Value */}
        <div className="mb-14">
          <div className="relative rounded-2xl bg-gradient-to-br from-[var(--bg-card)] via-[var(--bg-card)] to-[#10b981]/[0.02] border border-[var(--border)] p-6 lg:p-9 overflow-hidden shadow-[var(--shadow-md)]">
        ...
        <div className="mb-14">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
            {FEATURES.map((f, i) => (
              <div key={i} className="group p-5 text-center rounded-xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-[#10b981]/20 hover:shadow-[var(--shadow-md)] hover:-translate-y-1 transition-all duration-200 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-[#10b981]/[0.02] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none" />
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#10b981]/15 to-[#10b981]/5 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-all duration-200">
                  {(()=>{const I=icoMap[f.icon];return I?<I className="w-5 h-5 text-[#10b981]"/>:<HiSparkles className="w-5 h-5 text-[#10b981]"/>})()}
                </div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 relative">
            ...
            {HOW_IT_WORKS.steps.map((s, i) => (
              <div key={i} className="group p-5 text-center rounded-xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-[#10b981]/20 hover:shadow-[var(--shadow-md)] hover:-translate-y-1 transition-all duration-200 relative z-10 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-[#10b981]/[0.02] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none" />
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#10b981] to-[#059669] text-white flex items-center justify-center text-lg font-bold mx-auto mb-4 shadow-lg shadow-[#10b981]/25 group-hover:scale-110 transition-all duration-200">{s.step}</div>
