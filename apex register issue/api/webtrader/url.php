<?php
// api/webtrader/url.php — build trader login URL using Client Zone session (same email/password as login)
...
/*
 * Hints for the trader app when opened from Client Zone (iframe/embed).
 * If the partner app supports it, this can skip a duplicate "choose account" step.
 */
